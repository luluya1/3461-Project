...
# 6. In the main thread, repeatedly:
     ...
     # - To create a groupchat message, type in the format #groupchatname @username1, @username2... etc
     # - To send a groupchat message, type in the format #groupchat message
